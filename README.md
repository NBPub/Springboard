...
| 6 | [Guided Capstone](https://github.com/NBPub/DataScienceGuidedCapstone) | Data Science Method exercise, contained in external repository. Four notebook assignments and write-up. | *in progress* |
| . | . | . |
| . | . | . |
| . | . | . |
| . | . | . |